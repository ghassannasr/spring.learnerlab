...
## Developmental Notes
* Fork this repository, but DO NOT clone this repository.
	* Complete `Part 0.0` before beginning development.
...
* After the project has completed downloading, navigate to the download directory and unzip the project folder.
	* You may move it from the downloads folder to elsewhere if you would like.
...
* At the root directory of the project, execute the command below:
	* `git init`
	* `git remote add origin https://github.com/${my-username}/spring.learnerlab`
	* `git pull origin master`
	* `git add .`
	* `git commit -m "extracted contents of project generated by start.spring.io"`
